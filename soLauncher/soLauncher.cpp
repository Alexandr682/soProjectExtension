...
int APIENTRY _tWinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPTSTR lpCmdLine,int nCmdShow)
{
	...
	sti.wShowWindow = 1;
	// select app
#ifdef NEED_LAUNCH_COMAND_LAUNCHER
	if (!wcsstr(lpCmdLine, TEXT("-launcher")))
	{
		MessageBox(NULL, L"Error!\nPlease use MOD-Launcher for start game", L"S.T.A.L.K.E.R. Online", MB_OK);
		return 1;
	}
#endif // NEED_LAUNCH_COMAND_LAUNCHER
