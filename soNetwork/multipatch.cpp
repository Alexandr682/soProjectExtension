...
void Launch_Mod_Extension() //Расширение от MoD Team(DiR.X)
{
	...
	// ТЕСТ! Убирает ограничение патронов у НПС --- Not work?
	...
	HookHandle->Jmp(((DWORD)(gGameOffset)+0x355159), (DWORD)Hook_Open_PDA); //jmp Hook_open_pda Добавляет реакцию на клавишу ПДА
#endif
